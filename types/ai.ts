...
// 2. Definimos el esquema para las respuestas personalizadas
export const CustomResponseSchema = z.object({
    greeting: z.string().optional().describe("Mensaje de saludo inicial"),
    farewell: z.string().optional().describe("Mensaje de despedida"),
    outOfHours: z.string().optional().describe("Mensaje para fuera de horario"),
    customInstructions: z.string().optional().describe("Instrucciones específicas sobre qué contestar según el tipo de mensaje"),
});

// 3. Definimos el esquema maestro del negocio (Lo que irá a la columna JSONB de PostgreSQL)
export const BusinessConfigSchema = z.object({
    ...
    customResponses: CustomResponseSchema.optional().describe("Respuestas y mensajes personalizados del bot"),
});
