...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch("/api/register", { // <-- RUTA CORREGIDA
                method: "POST",
            ...
            if (loginResult?.error) {
                // Si el auto-login falla, redirigimos al login para que el usuario lo intente manualmente.
                // Esto es mejor que dejarlo en la página de registro con un error.
                router.push("/login");
                return;
            }
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                    ...
                    <div className="mt-6 flex items-center justify-between">
                        ...
                        <span className="text-xs text-center text-white/40 uppercase">O</span>
                        <span className="border-b border-white/10 w-1/5 lg:w-1/4"></span>
                    </div>
