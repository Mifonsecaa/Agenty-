...
const PLATFORMS = {
  whatsapp: {
    ...
    fields: [
      { key: "phoneNumberId", label: "Phone Number ID", placeholder: "ej. 123456789012345", type: "text" },
      { key: "accessToken", label: "Access Token", placeholder: "EAABs....", type: "password" },
      { key: "webhookVerifyToken", label: "Webhook Verify Token", placeholder: "tu_token_secreto", type: "text" },
    ],
