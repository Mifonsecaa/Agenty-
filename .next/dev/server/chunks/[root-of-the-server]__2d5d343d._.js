...
async function POST(req) {
    try {
                ...
                for (const file of files){
                    try {
                        ...
                        if (file.type === "application/pdf" || file.name.endsWith(".pdf")) {
                            try {
                                const pdf = __turbopack_context__.r("[externals]/pdf-parse [external] (pdf-parse, cjs, [project]/node_modules/pdf-parse)"); // Usar require para evitar problemas de ESM con esta librería legacy
        ...
        if (filesContent.length > 0) {
            ...
            await Promise.allSettled(filesContent.map((file)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$rag$2f$ingestion$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ingestionService"].ingestText(negocio.id, file.content, {
                    source: file.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d5d343d._.js.map