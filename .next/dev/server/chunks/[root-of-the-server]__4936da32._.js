...
async function GET(req) {
    try {
        ...
        const metrics = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyMetric.findMany({
            where: {
                businessId,
                date: {
                    gte: startDate
        ...
        const chartData = metrics.map((m)=>({
                name: m.date.toLocaleDateString('es-ES', {
                    weekday: 'short'
                }),
                tokens: m.tokensUsed,
        ...
        // Calcular totales
        const stats = metrics.reduce((acc, current)=>({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4936da32._.js.map