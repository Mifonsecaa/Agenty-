...
"[project]/services/database/business.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function saveWhatsAppCredentials(userId, accessToken) {
    try {
        ...
        const business = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].business.findFirst({
            where: {
                userId
            }
        });
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].business.update({
            where: {
                id: business.id
            },
            data: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$database$2f$business$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/database/business.ts [app-rsc] (ecmascript)"); // 1. Importar nuestro nuevo servicio
;
;
;
;
    ...
    callbacks: {
        async signIn ({ user, account }) {
            ...
            if (account?.provider === 'facebook' && account.access_token) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$database$2f$business$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["saveWhatsAppCredentials"])(user.id, account.access_token);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c895fd6f._.js.map