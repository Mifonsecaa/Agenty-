...
"[project]/app/api/business/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const businesses = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].business.findMany({
            where: {
                userId: user.id
            },
            orderBy: {
...
async function DELETE(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].business.delete({
            where: {
                id: businessId
            }
        });
...
async function PUT(req) {
    try {
        ...
        const updatedBusiness = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].business.update({
            where: {
                id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c9047116._.js.map