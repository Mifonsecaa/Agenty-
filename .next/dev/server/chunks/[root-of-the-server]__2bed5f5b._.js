...
const ragKeysByBusiness = new Map();
...
function capContextByChars(chunks, maxChars) {
    let used = 0;
    const selected = [];
                ...
                if (lastUserMessage && process.env.OPENAI_API_KEY) {
                    ...
                    if (cachedRag) {
                        ...
                        if (items && items.length > 0) {
                            ...
                            }).filter((item)=>item.vectorScore >= RAG_MIN_VECTOR_SIMILARITY || item.lexicalScore >= 0.28).sort((a, b)=>b.combinedScore - a.combinedScore).slice(0, finalTopK);
                            const seenChunkHashes = new Set();
                            const contextChunks = [];
                            for (const item of ranked){
                                const hash = typeof item.metadata.contentHash === "string" ? item.metadata.contentHash : buildCacheKey([
                                    "rag-content",
                                ...
                                const fileDescription = typeof item.metadata.title === "string" ? item.metadata.title : typeof item.metadata.source === "string" ? item.metadata.source : "Archivo adjunto";
                            ...
                            setCacheValue(ragCache, ragKey, {
                                ragContext,
                                availableFiles
                            }, RAG_CACHE_TTL_MS, RAG_CACHE_MAX_ENTRIES);
...
"[project]/lib/observability/ops-metrics.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function incrementOpsCounter(name, value = 1) {
    counters.set(name, (counters.get(name) || 0) + value);
}
function recordOpsDuration(name, durationMs) {
...
"[project]/lib/security/traffic-control.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/observability/ops-metrics.ts [app-route] (ecmascript)");
;
...
function makeRedisKey(type, scope, key) {
...
async function getRedisClient() {
    ...
    if (!redisMetricsReported.enabled) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("traffic.redis_enabled");
        ...
        redisClientPromise = (async ()=>{
            try {
                ...
                if (!redisMetricsReported.unavailable) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("traffic.redis_unavailable");
    ...
    try {
        ...
        if (!redisMetricsReported.connected) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("traffic.redis_connected");
...
function buildRequesterKey(req) {
...
async function checkRateLimit(params) {
    ...
    if (!client) {
        if (!redisMetricsReported.fallback && isRedisEnabled()) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("traffic.redis_fallback_memory");
...
function acquireConcurrencySlotMemory(params) {
    ...
    const current = concurrencyBuckets.get(bucketKey) || {
        count: 0,
        updatedAt: nowMs()
    };
...
async function releaseRedisConcurrency(scope, key) {
    const client = await getRedisClient();
    if (!client) return;
    try {
...
async function acquireConcurrencySlot(params) {
    const { scope, key, maxConcurrent } = params;
    const client = await getRedisClient();
    if (!client) {
        if (!redisMetricsReported.fallback && isRedisEnabled()) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$traffic$2d$control$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/security/traffic-control.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/observability/ops-metrics.ts [app-route] (ecmascript)");
;
;
;
...
async function POST(req) {
    ...
    try {
        ...
        const rate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$traffic$2d$control$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])({
        ...
        if (!rate.allowed) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("knowledge.rate_limited");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const concurrencySlot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$security$2f$traffic$2d$control$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["acquireConcurrencySlot"])({
            scope: "api-knowledge-business",
            key: businessId,
            maxConcurrent: Number(process.env.KNOWLEDGE_POST_MAX_CONCURRENT || 2)
        });
        if (!concurrencySlot) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("knowledge.concurrency_rejected");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Servidor ocupado procesando conocimiento. Intenta de nuevo."
            }, {
                status: 503
            });
        }
        ...
        if (enqueue.missingQueueTable) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("knowledge.sync_fallback");
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordOpsDuration"])("knowledge.post_latency_ms", Date.now() - startedAt);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("knowledge.queued");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordOpsDuration"])("knowledge.post_latency_ms", Date.now() - startedAt);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            queued: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["incrementOpsCounter"])("knowledge.error");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$observability$2f$ops$2d$metrics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordOpsDuration"])("knowledge.error_latency_ms", Date.now() - startedAt);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2bed5f5b._.js.map