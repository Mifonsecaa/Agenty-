    ...
    async ingestText(businessId, text, metadata = {}) {
        ...
        try {
            ...
            if (metadata.fileName) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].knowledgeItem.deleteMany({
                    where: {
                        businessId,
                        metadata: {
                            path: [
            ...
            const cleanMetadata = Object.entries(metadata).reduce((acc, [key, val])=>{
            ...
            for (const doc of docs){
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].knowledgeItem.create({
                    data: {
                        businessId,
                        ...
                        metadata: {
                            ...cleanMetadata,
                            fileName: cleanMetadata.fileName || "unknown",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b214896d._.js.map