...
"[project]/context/AgentyContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const AgentyContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function AgentyProvider({ children, initialAgents = [] }) {
    ...
    const [activeAgent, setActiveAgent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialAgents.length > 0 ? initialAgents[0] : null);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialAgents.length === 0); // Only loading if no initial data
    const refreshAgents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AgentyProvider.useCallback[refreshAgents]": async ()=>{
            ...
            try {
                ...
                if (!response.ok) {
                    const errorData = await response.json().catch({
                        "AgentyProvider.useCallback[refreshAgents]": ()=>({})
                    }["AgentyProvider.useCallback[refreshAgents]"]);
                ...
                if (data.success && data.businesses) {
                    ...
                    let active = fetchedAgents.find({
                        "AgentyProvider.useCallback[refreshAgents]": (a)=>a.id === activeId
                    }["AgentyProvider.useCallback[refreshAgents]"]) || fetchedAgents[0];
                    if (active) {
    ...
    const switchAgent = (agentId)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Cambiado a ${agent.name || 'Agente'}`);
    };
    ...
    const saveAgent = async (agentId, name, config)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : "Error al guardar");
            return false;
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AgentyContext.Provider, {
        value: {
            agents,
            activeAgent,
            isLoading,
...
_s(AgentyProvider, "jhHJrtRv8DoUwPxkeoFjMy4aTik=", false, function() {
    return [
...
function useAgenty() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(AgentyContext);
    if (context === undefined) {
        throw new Error('useAgenty must be used within an AgentyProvider');
    }
    return context;
}
_s1(useAgenty, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "AgentyProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/dashboard/dashboardCopy.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/dashboard/useDashboardCopy.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useDashboardCopy() {
    ...
    const copy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDashboardCopy.useMemo[copy]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$dashboardCopy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDashboardCopy"])(locale)
    }["useDashboardCopy.useMemo[copy]"], [
        locale
    ]);
...
_s(useDashboardCopy, "hUFWAN5k8D95CE3VUBmfMSB5xLA=", false, function() {
    return [
...
"[project]/components/dashboard/ActionConfirmationPanel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$useDashboardCopy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/dashboard/useDashboardCopy.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
function ActionConfirmationPanel({ message, details, confirmLabel, cancelLabel, onConfirm, onCancel, isLoading = false, disabled = false }) {
    _s();
    const { copy } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$useDashboardCopy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardCopy"])();
...
_s(ActionConfirmationPanel, "c4poFNjLwBf76NRaO5RsL83aNjc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$useDashboardCopy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardCopy"]
    ];
});
_c = ActionConfirmationPanel;
var _c;
__turbopack_context__.k.register(_c, "ActionConfirmationPanel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function DashboardShell({ children, initialAgents, userName, userEmail }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AgentyContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AgentyProvider"], {
...
function DashboardContent({ children, userName, userEmail }) {
    ...
    const { copy, locale, setDashboardLocale } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$dashboard$2f$useDashboardCopy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardCopy"])();
    const { agents, activeAgent, switchAgent, refreshAgents } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AgentyContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAgenty"])();
    ...
    const [handoffCount, setHandoffCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [pendingDeleteAgentId, setPendingDeleteAgentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isDeletingAgent, setIsDeletingAgent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isClearNotificationsConfirmOpen, setIsClearNotificationsConfirmOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardContent.useEffect": ()=>{
            ...
            const handleClickOutside = {
                "DashboardContent.useEffect.handleClickOutside": (event)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardContent.useEffect": ()=>{
            ...
            let cancelled = false;
            const fetchHandoffCount = {
                "DashboardContent.useEffect.fetchHandoffCount": async ()=>{
                    try {
                        const res = await fetch(`/api/chats?businessId=${activeAgent.id}`);
                        const data = await res.json();
                        if (!res.ok || !data?.success || cancelled) return;
                        const count = Array.isArray(data.chats) ? data.chats.filter({
                            "DashboardContent.useEffect.fetchHandoffCount": (chat)=>chat?.status === "handoff"
                        }["DashboardContent.useEffect.fetchHandoffCount"]).length : 0;
                        setHandoffCount(count);
                    } catch  {
                    // No bloqueamos UI por error de métrica de badge
                    }
                }
            }["DashboardContent.useEffect.fetchHandoffCount"];
            fetchHandoffCount();
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                                children: isDropdownOpen && !isCollapsed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                    ...
                                    children: [
                                        ...
                                        agents.map((ag)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(DashboardContent, "3IJuXTeF1IkB9oEKvlXv7Slw0xc=", false, function() {
    return [
...
//# sourceMappingURL=_1599d9bc._.js.map