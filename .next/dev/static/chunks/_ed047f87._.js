...
const dashboardCopyByLocale = {
    es: {
        ...
        knowledge: {
            unsupportedFileType: (type)=>`El tipo de archivo \"${type}\" no es soportado. Sube .txt, .md, .csv, .json, .xlsx, .xlsm, imagenes o PDF.`,
    ...
    en: {
        ...
        knowledge: {
            unsupportedFileType: (type)=>`File type \"${type}\" is not supported. Upload .txt, .md, .csv, .json, .xlsx, .xlsm, images, or PDF.`,
...
_s(ActionConfirmationPanel, "a+DZx9DY26Zf8FVy1bxe3vp9l1w=", false, function() {
    return [
...
_s(DashboardContent, "CCdKy2lP/3TEXX2BCK7/qhXOONM=", false, function() {
    return [
...
//# sourceMappingURL=_ed047f87._.js.map